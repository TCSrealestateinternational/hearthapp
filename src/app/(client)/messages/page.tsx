        ...
        {depsLoading ? (
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center p-4">
              <MaterialIcon name="warning" size={40} className="mx-auto mb-3 text-warning" />
              <p className="text-on-surface font-medium">Messaging not available</p>
            ...
            {messages.length > 0 ? (
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  <MaterialIcon name="chat_bubble" size={40} className="mx-auto mb-3 text-on-surface-variant opacity-50" />
