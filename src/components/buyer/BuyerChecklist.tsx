...
import { BUYER_STAGES } from "@/constants/checklist-buyer";
...
export function BuyerChecklist({ items, onToggle }: BuyerChecklistProps) {
  const currentStage = useMemo(() => findCurrentStage(items, BUYER_STAGES), [items]);
